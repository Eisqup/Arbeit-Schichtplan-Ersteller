...
def get_holiday_dates(year):
    ...
    school_holidays_url = f"https://openholidaysapi.org/SchoolHolidays?countryIsoCode=DE&languageIsoCode=DE&validFrom={year-1}-12-15&validTo={year+1}-02-02&subdivisionCode=DE-BE"
    public_holidays_url = f"https://openholidaysapi.org/PublicHolidays?countryIsoCode=DE&languageIsoCode=DE&validFrom={year-1}-12-15&validTo={year +1}-02-02&subdivisionCode=DE-BE"
